<?php
	...
	$row_loai=mysqli_query($sql_loai);
?>
<div class="box_list">
            <div class="tieude">
            	<h3>Loại phụ kiện</h3>
	...
	$row_hieu=mysqli_query($sql_hieu);
?>
                <div class="box_list">
            <div class="tieude">
            	<h3>Thương hiệu</h3>
            	...
            	<h3>Hàng bán chạy</h3>
                    ...
                    <?php
					$sql_banchay=mysqli_query("select * from sanpham order by idsanpham desc limit 8");
				...
				?>
                 ...
                 <div class="box_list">
                 <?php
				 	$sql=mysqli_query("select * from tintuc");
